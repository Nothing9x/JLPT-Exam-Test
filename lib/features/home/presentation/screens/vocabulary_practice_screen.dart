...
class _VocabularyPracticeScreenState extends State<VocabularyPracticeScreen> {
            ...
            Expanded(
              child: FutureBuilder<Map<String, CategoryWithTypes>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final vocabularyCategory = categories['VOCABULARY'];

                  if (vocabularyCategory == null ||
                      vocabularyCategory.types.isEmpty) {
                    return Center(
                      child: Text(
                        'No vocabulary types available',
                        style: TextStyle(
                          color: isDark
                              ? AppColors.textSecondaryDark
                              : AppColors.textSecondaryLight,
                  ...
                  final types = vocabularyCategory.types.where((type) {
                  ...
                  if (types.isEmpty) {
                    return Center(
                      child: Text(
                        'No vocabulary types available for your level',
                        style: TextStyle(
                          color: isDark
                              ? AppColors.textSecondaryDark
                              : AppColors.textSecondaryLight,
  ...
  Widget _buildPracticeTypeCard(
    ...
    // For now we use the count of practiced questions as a proxy
    // TODO: In future, we should track which questions belong to which type
