...
class GrammarPracticeScreen extends StatefulWidget {
  ...
  @override
  State<GrammarPracticeScreen> createState() =>
            ...
            Expanded(
              child: FutureBuilder<Map<String, CategoryWithTypes>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final grammarCategory = categories['GRAMMAR'];

                  if (grammarCategory == null ||
                      grammarCategory.types.isEmpty) {
                    return Center(
                      child: Text(
                        'No grammar types available',
                        style: TextStyle(
                          color: isDark
                              ? AppColors.textSecondaryDark
                              : AppColors.textSecondaryLight,
                  ...
                  final types = grammarCategory.types.where((type) {
                  ...
                  if (types.isEmpty) {
                    return Center(
                      child: Text(
                        'No grammar types available for your level',
                        style: TextStyle(
                          color: isDark
                              ? AppColors.textSecondaryDark
                              : AppColors.textSecondaryLight,
