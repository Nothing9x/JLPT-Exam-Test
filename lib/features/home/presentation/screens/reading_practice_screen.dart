            ...
            Expanded(
              child: FutureBuilder<Map<String, CategoryWithTypes>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final readingCategory = categories['READING'];

                  if (readingCategory == null ||
                      readingCategory.types.isEmpty) {
                    return Center(
                      child: Text(
                  ...
                  final types = readingCategory.types.where((type) {
                  ...
                  if (types.isEmpty) {
                    return Center(
                      child: Text(
                        'No reading types available for your level',
                        style: TextStyle(
                          color: isDark
                              ? AppColors.textSecondaryDark
                              : AppColors.textSecondaryLight,
